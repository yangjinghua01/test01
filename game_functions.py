...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if len(aliens) == 0:
        # 若所有的外星人全都被消灭，就提高一个等级
        # 删除现有的子弹并新建一群外星人,并加快节奏
        bullets.empty()
...
def update_alien(ai_setting,  screen, stats, sb, ship, aliens, bullets ):
    # 更新外星人群中所有外星人的位置
    check_fleet_edages(ai_setting,aliens)
    aliens.update()
